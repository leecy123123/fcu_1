    ...
    for i_episode in range(len(cl_data.columns)):  # i_episode=0-10000+
        ...
        for i in range(len(cl_data)):  # i = 0-13
            ...
            if s != 0:
                ...
                # a_water_range = range(80, 700)  # 80 to 700 inclusive
                # a_air_range = range(100, 1200)  # 100 to 1200 inclusive
                ...
                print('迭代 {}: {} - 状态s: {}, 最优动作: {}'.format(iteration, current_time, s, best_combination))
...
if __name__ == '__main__':
    ...
    save_path = '../contrast_experiment_result/RBC/'
    room_name = '1-N-6'
    win_len = 14
